...
#ifndef niftkVLStandardDisplayEditor_h
#define niftkVLStandardDisplayEditor_h
 ...
 * \brief Simple editor that delegates all functionality to a niftk::VLStandardDisplayWidget,
...
public:
  ...
  berryObjectMacro(VLStandardDisplayEditor)
...
private:
  ...
  const QScopedPointer<VLStandardDisplayEditorPrivate> d;
