...
//-----------------------------------------------------------------------------
SegmentationPerspective::SegmentationPerspective()
{
}


//-----------------------------------------------------------------------------
SegmentationPerspective::SegmentationPerspective(const SegmentationPerspective& other)
{
  Q_UNUSED(other)
...
//-----------------------------------------------------------------------------
void SegmentationPerspective::CreateInitialLayout(berry::IPageLayout::Pointer layout)
{
