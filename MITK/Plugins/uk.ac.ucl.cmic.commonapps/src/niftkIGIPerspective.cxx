...
//-----------------------------------------------------------------------------
IGIPerspective::IGIPerspective()
{
}


//-----------------------------------------------------------------------------
IGIPerspective::IGIPerspective(const IGIPerspective& other)
{
  Q_UNUSED(other)
...
//-----------------------------------------------------------------------------
void IGIPerspective::CreateInitialLayout(berry::IPageLayout::Pointer layout)
{
