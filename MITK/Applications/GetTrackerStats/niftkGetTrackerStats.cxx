...
#include <niftkGetTrackerStatsCLP.h>
...
int main(int argc, char** argv)
{
  ...
  try
  {
    ...
    projector->SetVisualiseTrackingStatus(false);
    projector->SetWriteTrackingPositionData(true);
    ...
    {
      matcher->SetCameraToTrackers(handeyes);
    }
    ...
    matcher->SetWriteTimingErrors(false);
