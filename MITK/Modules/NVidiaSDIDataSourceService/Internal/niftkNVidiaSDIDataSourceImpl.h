...
#ifndef niftkNVidiaSDIDataSourceImpl_h
#define niftkNVidiaSDIDataSourceImpl_h
...
class NVidiaSDIDataSourceImpl : public IGITimerBasedThread
{
  Q_OBJECT
