...
IGIVideoOverlayWidget::IGIVideoOverlayWidget(QWidget * /*parent*/)
{
  ...
  m_LeftImagePushButton->setChecked(true);
  m_RightImagePushButton->setChecked(false);
  m_3DViewerPushButton->setChecked(true);

  connect(m_3DViewerPushButton, SIGNAL(toggled(bool)), this, SLOT(On3DViewerCheckBoxChecked(bool)));
  connect(m_LeftImagePushButton, SIGNAL(toggled(bool)), this, SLOT(OnLeftOverlayCheckBoxChecked(bool)));
  connect(m_LeftImageCombo, SIGNAL(OnSelectionChanged(const mitk::DataNode*)), this, SLOT(OnLeftImageSelected(const mitk::DataNode*)));
  connect(m_RightImagePushButton, SIGNAL(toggled(bool)), this, SLOT(OnRightOverlayCheckBoxChecked(bool)));
