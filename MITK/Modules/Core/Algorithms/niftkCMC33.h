...
public :
  ...
  */
  ...
  inline void  set_output_data  (MeshData * meshData) { m_MeshDataExt = meshData; }
...
protected :
  ...
  MeshData * m_MeshDataExt;  /**< externally allocated data structure that contains the mesh that we're working on*/
