...
#ifndef niftkImageToSurfaceFilter_h
#define niftkImageToSurfaceFilter_h
...
class NIFTKCORE_EXPORT ImageToSurfaceFilter : public mitk::SurfaceSource
{
public:
