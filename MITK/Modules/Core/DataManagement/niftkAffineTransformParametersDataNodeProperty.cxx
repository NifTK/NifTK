...
//-----------------------------------------------------------------------------
bool AffineTransformParametersDataNodeProperty::IsEqual(const mitk::BaseProperty& property) const
{
...
//-----------------------------------------------------------------------------
bool AffineTransformParametersDataNodeProperty::Assign(const mitk::BaseProperty& property)
{
  const Self *other = dynamic_cast<const Self*>(&property);
