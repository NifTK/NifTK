...
#ifndef niftkDataNodeStringPropertyFilter_h
#define niftkDataNodeStringPropertyFilter_h
 ...
 * otherwise Pass=true.
 */
class NIFTKCORE_EXPORT DataNodeStringPropertyFilter : public DataNodeFilter
{

public:

  mitkClassMacro(DataNodeStringPropertyFilter, DataNodeFilter)
