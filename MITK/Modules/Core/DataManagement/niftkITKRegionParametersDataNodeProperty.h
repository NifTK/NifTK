...
#ifndef niftkITKRegionParametersDataNodeProperty_h
#define niftkITKRegionParametersDataNodeProperty_h
 ...
 */
class NIFTKCORE_EXPORT ITKRegionParametersDataNodeProperty : public mitk::BaseProperty
{
