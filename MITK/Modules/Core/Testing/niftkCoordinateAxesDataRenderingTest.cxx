...
/**
 * \file Test harness for niftk::CoordinateAxesData and niftk::CoordinateAxesVtkMapper3D.
 */
int niftkCoordinateAxesDataRenderingTest(int argc, char * argv[])
{
  // Always start with this, with name of function.
  MITK_TEST_BEGIN("niftkCoordinateAxesDataRenderingTest");

  // Create axes node
  niftk::CoordinateAxesData::Pointer axes = niftk::CoordinateAxesData::New();
