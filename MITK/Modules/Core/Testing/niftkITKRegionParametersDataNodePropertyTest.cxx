...
void TestInstantiation()
{
  ...
  ITKRegionParametersDataNodeProperty::Pointer prop1 = ITKRegionParametersDataNodeProperty::New();
...
void TestIdentity()
{
  ...
  ITKRegionParametersDataNodeProperty::Pointer prop1 = ITKRegionParametersDataNodeProperty::New();
  ITKRegionParametersDataNodeProperty::ParametersType params = prop1->GetITKRegionParameters();
...
/**
 * Basic test harness for niftkITKRegionParametersDataNodeProperty.h
 */
int niftkITKRegionParametersDataNodePropertyTest(int argc, char * argv[])
{
  // always start with this!
  MITK_TEST_BEGIN("niftkITKRegionParametersDataNodePropertyTest")

  niftk::TestInstantiation();
  niftk::TestIdentity();
  niftk::TestSetGet();
