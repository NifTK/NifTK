...
//-----------------------------------------------------------------------------
bool ITKRegionParametersDataNodeProperty::IsEqual(const mitk::BaseProperty& property) const
{
...
//-----------------------------------------------------------------------------
bool ITKRegionParametersDataNodeProperty::Assign(const mitk::BaseProperty& property)
{
  const Self* other = dynamic_cast<const Self*>(&property);
