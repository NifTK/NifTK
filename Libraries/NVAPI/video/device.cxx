...
static bool map_nvformat_to_interlaced(NVVIOSIGNALFORMAT signalformat)
{
    switch (signalformat)
    {
        ...
        // untested: dont have 3g hardware
        ...
        // untested: not sure what to do with psf formats...
        ...
        // all known formats are handling above.
        // if there are more later then we'd want to know about it.
        default:
            assert(false);
            return false;
    }
...
static StreamFormat::RefreshRate map_nvformat_to_rr(NVVIOSIGNALFORMAT signalformat)
{
    switch (signalformat)
    {
        ...
        case NVVIOSIGNALFORMAT_1080P_60_00_SMPTE274_3G_LEVEL_A:
        case NVVIOSIGNALFORMAT_1080P_60_00_SMPTE274_3G_LEVEL_B:
            return StreamFormat::RR_60;

        case NVVIOSIGNALFORMAT_720P_59_94_SMPTE296:
        case NVVIOSIGNALFORMAT_1080P_59_94_SMPTE274_3G_LEVEL_A:
        case NVVIOSIGNALFORMAT_1080P_59_94_SMPTE274_3G_LEVEL_B:
            return StreamFormat::RR_59_94;

        case NVVIOSIGNALFORMAT_720P_23_98_SMPTE296:
        case NVVIOSIGNALFORMAT_1080P_23_98_SMPTE274_3G_LEVEL_B:
        case NVVIOSIGNALFORMAT_1080P_23_976_SMPTE274:             // the odd one out?
        case NVVIOSIGNALFORMAT_2048P_23_98_SMPTE372_3G_LEVEL_B:
        case NVVIOSIGNALFORMAT_2048P_23_98_SMPTE372:
        case NVVIOSIGNALFORMAT_1080I_47_96_SMPTE274:
        case NVVIOSIGNALFORMAT_2048I_47_96_SMPTE372:
        ...
        case NVVIOSIGNALFORMAT_2048I_47_96_SMPTE372_3G_LEVEL_B:
        case NVVIOSIGNALFORMAT_1080PSF_23_98_SMPTE274:
            return StreamFormat::RR_23_976;

        default:
            // should be all defined formats at the time of writing.
            // so if there's a new one then barf.
            assert(false);
            return StreamFormat::RR_NONE;
    }
...
static StreamFormat::PictureFormat map_nvformat_to_pf(NVVIOSIGNALFORMAT signalformat)
{
    switch (signalformat)
    {
        ...
        case NVVIOSIGNALFORMAT_1035I_59_94_SMPTE260:
        case NVVIOSIGNALFORMAT_1035I_60_00_SMPTE260:
            return StreamFormat::PF_1035;

        default:
            // these should be all. if there are new ones then we want to know about it.
            assert(false);
    }
