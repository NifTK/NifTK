...
class ITK_EXPORT MatrixBasedSimulReconRegnMethod : public ProcessObject 
{
public:
  /** Standard class typedefs. */
  typedef MatrixBasedSimulReconRegnMethod  													Self;
  ...
  itkTypeMacro(MatrixBasedSimulReconRegnMethod, ProcessObject);
  ...
  typedef MatrixBasedSimulReconRegnMetric<double>												MetricType;
  ...
  /// Set the 3D affine transformation parameters estimate
  void SetAffineEstimate( EulerAffineTransformType *affinePara);
...
private:
  MatrixBasedSimulReconRegnMethod(const Self&); 	// purposely not implemented
  ...
  MatrixFormReconstructionPointer            			m_VolumeEstimate;
	EulerAffineTransformPointer											m_EulerAffineEstimate;
...
#include "itkMatrixBasedSimulReconRegnMethod.txx"
#endif
