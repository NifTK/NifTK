...
class ITK_EXPORT ImageMatrixFormReconstructionMethod : public ProcessObject 
{
public:
  /** Standard class typedefs. */
  typedef ImageMatrixFormReconstructionMethod  					Self;
  ...
  itkTypeMacro(ImageMatrixFormReconstructionMethod, ProcessObject);
  ...
  typedef ImageMatrixFormReconstructionMetric<double>				 						MetricType;
...
private:
  ImageMatrixFormReconstructionMethod(const Self&); // purposely not implemented
...
#include "itkImageMatrixFormReconstructionMethod.txx"
#endif
