...
int main(int argc, char** argv)
{
  ...
  typedef itk::ImageMatrixFormReconTwoDataSetsWithoutRegMetric < double > 												ImageMatrixFormReconTwoDataSetsWithoutRegMetricType;

  typedef itk::ImageMatrixFormReconTwoDataSetsWithoutRegMethod <IntensityType> 										ImageMatrixFormReconTwoDataSetsWithoutRegMethodType;
  typedef ImageMatrixFormReconTwoDataSetsWithoutRegMethodType::MatrixFormReconstructionType  			MatrixFormReconstructionType;
  ...
  typedef ImageMatrixFormReconTwoDataSetsWithoutRegMethodType::MatrixFormReconstructionType				ImageMatrixFormReconstruction3D;	
  ...
  parameters[8] = 1.;		// Scale factor along the 'z' axis
	...
	parameters[0] = -10.; 	// Translation along the 'x' axis
	parameters[2] = 20.; // Translation along the 'z' axis

	parameters[4] = 30.;  // Roation along the 'x' axis
  ...
  ImageMatrixFormReconTwoDataSetsWithoutRegMetricType::Pointer imageMatrixFormReconTwoDataSetsWithoutRegMetric = ImageMatrixFormReconTwoDataSetsWithoutRegMetricType::New();

  // Set the 3D reconstruction estimate input volume (x)
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetInputVolume( inImageEstimation );

	// Set the 3D reconstruction estimate input volume as a vector form
	imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetInputVolumeVector( initialEstimateImageVector );

  // Set the inputs of (y_1) and (y_2)
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetInputTwoProjectionVectors( forwardProjectedVectorOne, forwardProjectedVectorTwo );

  // Set the temporary projection image
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetInputTempProjections( outImage );

  // Set the total number of the voxels of the volume
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetTotalVoxel( totalSize3D );

  // Set the total number of the pixels of the projection
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetTotalPixel( totalSize2D );

  // Set the total number of the pixels of the projection
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetTotalProjectionNumber( projectionNumber );

  //Set the total number of the pixels of the projection
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetTotalProjectionSize( nPixels2D );

  // Set the geometry
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetProjectionGeometry( geometry );

	// Set the size, resolution and origin of the input volume
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetInputVolumeSize( nVoxels3D );
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetInputVolumeSpacing( spacing3D );
  imageMatrixFormReconTwoDataSetsWithoutRegMetric->SetInputVolumeOrigin( origin3D );

  // Create the reconstructor
  // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

  ImageMatrixFormReconTwoDataSetsWithoutRegMethodType::Pointer imReconstructor = ImageMatrixFormReconTwoDataSetsWithoutRegMethodType::New();
...
*/
  ...
  imReconstructor->SetMetric( imageMatrixFormReconTwoDataSetsWithoutRegMetric );
  ...
  try {
    ...
    if (flgDebug)
      cout << "ImageMatrixFormReconTwoDataSetsWithoutRegMethod: " << imReconstructor << endl;
