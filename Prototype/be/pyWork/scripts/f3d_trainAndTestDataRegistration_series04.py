...
#lTargets     = fc.limitToTestData(  fc.getDeformed ( imgFiles ) )
lTargets     = fc.getDeformed ( imgFiles )
...
####
bendingEnergy        = 0.0
logOfJacobians       = [ 0.995 ] # to be varied over the iterations...
finalGridSpacing     = 20.0
numberOfLevels       = 1
maxIterations        = 300
affineInit           = 'C:/data/regValidationWithTannerData/outAladin/cfg247/'   # directory with the  initialisations
gpu                  = True
