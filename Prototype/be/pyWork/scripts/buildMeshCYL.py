...
breastTissueMaskImage = 'W:/philipsBreastProneSupine/ManualSegmentation/cylinderMasks/TissueMaskCYL-pad2.nii'
...
vtk2stl.vtk2stl([ breastSurfMeshVTK ])


#
#
# The resulting files were improved using MeshLab 
# - Filters -> Remeshing -> Uniform Mesh Resampling -> 2.2% precision
