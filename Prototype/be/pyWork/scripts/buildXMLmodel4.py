...
genFix.setMaterialElementSet( 'NH', 'FAT',    [  300, 50000], matGen.fatElemetns    )
genFix.setMaterialElementSet( 'NH', 'SKIN',   [ 1800, 50000], matGen.skinElements   )
genFix.setMaterialElementSet( 'NH', 'GLAND',  [  600, 50000], matGen.glandElements  )
genFix.setMaterialElementSet( 'NH', 'MUSCLE', [ 1000, 50000], matGen.muscleElements )

genFix.setGravityConstraint( [0., 1, 0 ], 28, allNodesArray, 'RAMP' )
genFix.setOutput( 5000, 'U' )
genFix.setSystemParameters( timeStep=1e-5, totalTime=1, dampingCoefficient=30, hgKappa=0.05, density=1000 )    
