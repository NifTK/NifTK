...
int main(int argc, char** argv)
{
  ...
  std::cout << "Before the SDM transform is initialised" << std::endl;
 
  SDMTransform->Initialize();

  std::cout << "The SDM transform is initialised" << std::endl;
  ...
  std::cout << "The transformation coefficients are read" << std::endl;
  ...
  typedef InputImageType::RegionType      ImageRegionType2D;
