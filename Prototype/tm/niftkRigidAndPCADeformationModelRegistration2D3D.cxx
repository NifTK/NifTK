...
int main( int argc, char * argv[] )
{
 ...
 { 
   ...
   std::cerr << argv[0] << " fixedImageFile  movingImageFile  outputImageFile outputParametersFile xstart ystart xsize ysize numberOfIterations PCAParametersDimension PCA_C0 PCA_C1 PCA_C2 PCA_C3 PCA_C4 PCA_C5";
   std::cerr <<  std::endl;
   return EXIT_FAILURE;
 }
 ...
 int PCAParametersDimension = atoi( argv[10] ); 
