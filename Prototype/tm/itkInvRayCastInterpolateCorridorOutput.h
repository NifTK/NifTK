...
=========================================================================*/
#ifndef __itkInvRayCastInterpolateCorridorOutput_h
#define __itkInvRayCastInterpolateCorridorOutput_h
...
class ITK_EXPORT InvRayCastInterpolateCorridorOutput : 
    public InterpolateImageFunction<TInputImage,TCoordRep> 
{
public:
  /** Standard class typedefs. */
  typedef InvRayCastInterpolateCorridorOutput             Self;
  ...
  itkTypeMacro(InvRayCastInterpolateCorridorOutput, InterpolateImageFunction);
  ...
  virtual OutputType EvaluateForOnePosition( const PointType& point ) const;
  ...
  void SetNeighCorridorAfterTranfFileName ( std::string name )
    { m_neighAfterFileName = name; }
 
  void SetCorridorBeforeTranfFileName ( std::string name )
    { m_beforeFileName = name; }
...
protected:
  ...
  std::string m_neighAfterFileName;
  std::string m_beforeFileName;
    
private:
  InvRayCastInterpolateCorridorOutput( const Self& ); //purposely not implemented
...
#include "itkInvRayCastInterpolateCorridorOutput.txx"
#endif
