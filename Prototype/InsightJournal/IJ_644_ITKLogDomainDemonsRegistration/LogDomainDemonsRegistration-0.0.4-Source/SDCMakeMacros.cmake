...
MACRO(ADD_MEX_FILE Target)
  ...
  ELSE(MSVC)
    ...
    IF(APPLE)
      IF(CMAKE_OSX_ARCHITECTURES MATCHES i386)
        # mac intel
        SET_TARGET_PROPERTIES(${Target} PROPERTIES LINK_FLAGS "-L${MATLAB_SYS} -Wl,-flat_namespace -undefined suppress -Wl,-exported_symbols_list,${MATLAB_INCLUDE_DIR}/../lib/maci/mexFunction.map")
      ELSE(CMAKE_OSX_ARCHITECTURES MATCHES i386)
        # mac powerpc?
        SET_TARGET_PROPERTIES(${Target} PROPERTIES LINK_FLAGS "-L${MATLAB_SYS} -Wl,-flat_namespace -undefined suppress -Wl,--version-script,${MATLAB_INCLUDE_DIR}/../lib/mac/mexFunction.map")
      ENDIF(CMAKE_OSX_ARCHITECTURES MATCHES i386)
    ELSE(APPLE)
      IF(CMAKE_SIZEOF_VOID_P MATCHES "4")
