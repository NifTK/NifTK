...
macro(NIFTK_CREATE_COMMAND_LINE_APPLICATION)
  ...
  set(multiValueArgs TARGET_LIBRARIES LINK_DIRECTORIES INCLUDE_DIRECTORIES)
  ...
  if(_APP_BUILD_SLICER)
    ...
    SEMMacroBuildNifTKCLI(
      ...
      LINK_DIRECTORIES ${_APP_LINK_DIRECTORIES}
      INCLUDE_DIRECTORIES ${_APP_INCLUDE_DIRECTORIES}
    )
  endif()
  ...
  set_property(TARGET ${_APP_NAME} PROPERTY FOLDER "Command line Apps")
