...
if(MITK_USE_QT)
  list(APPEND depends CTK)
endif()
if(BUILD_NiftyIGI)
  list(APPEND depends OpenCV NiftyLink)
endif()
if(MITK_USE_Python)
...
niftkMacroDefineExternalProjectVariables(MITK ${version} ${location} "${depends}")
...
if(NOT DEFINED MITK_DIR)
    ...
    if(NIFTK_Apps/NiftyIGI OR NIFTK_Apps/NiftyMIDAS OR NIFTK_Apps/NiftyMITKView)
      ...
      if(MITK_USE_BLUEBERRY)
        ...
        list(APPEND _enabled_plugins
          ...
          org.blueberry.ui.qt             # needed by NiftyMITKView
          ...
          org.mitk.gui.qt.datamanager     # needed by NiftyMITKView
