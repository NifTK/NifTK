 ...
 * \file niftkAnd.cxx
 * \page niftkAnd
 * \section niftkAndSummary Runs ITK AAndImageFilter to add two images of equal sizes on a voxel by voxel basis.
 *
...
void Usage(char *exec)
  {
    ...
    std::cout << "  " << std::endl;
    std::cout << "  Runs ITK and image function" << std::endl;
    std::cout << "  " << std::endl;
