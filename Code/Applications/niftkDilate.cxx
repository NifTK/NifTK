...
int main(int argc, char** argv)
{
  ...
  typedef itk::BinaryDilateImageFilter<InputImageType, InputImageType, StructuringElementType> DilateImageFilterType;
  DilateImageFilterType::Pointer filter = DilateImageFilterType::New();
  ...
  std::cout << "Filtering with radius:" + niftk::ConvertToString(radius)
      ...
      << ", dilateValue:" << niftk::ConvertToString(dilateValue)
