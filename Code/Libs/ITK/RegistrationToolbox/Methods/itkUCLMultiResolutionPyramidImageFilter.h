/*=========================================================================
  ...
  Module:    $RCSfile: itkUCLMultiResolutionPyramidImageFilter.h,v $
  Language:  C++
 ...
 *
 * UCLMultiResolutionPyramidImageFilter provides a generic framework to
...
template <
  ...
  >
class ITK_EXPORT UCLMultiResolutionPyramidImageFilter : 
...
public:
  ...
  itkTypeMacro(UCLMultiResolutionPyramidImageFilter, ImageToImageFilter);
  ...
  /** UCLMultiResolutionPyramidImageFilter produces images which are of
   * different resolution and different pixel spacing than its input image.
   * As such, UCLMultiResolutionPyramidImageFilter needs to provide an
  ...
  /** UCLMultiResolutionPyramidImageFilter requires a larger input requested
   * region than the output requested regions to accomdate the shrinkage and
   * smoothing operations. As such, UCLMultiResolutionPyramidImageFilter needs
...
private:
  UCLMultiResolutionPyramidImageFilter(const Self&); //purposely not implemented
...
#include "itkUCLMultiResolutionPyramidImageFilter.txx"
#endif
