...
#ifndef ITKMIDASWIPEPLUSPROCESSOR_H
#define ITKMIDASWIPEPLUSPROCESSOR_H
...
/**
 * \class MIDASWipePlusProcessor
 * \brief Provides the MIDAS Wipe Plus operation in the Irregular Volume Editor.
 *
...
class ITK_EXPORT MIDASWipePlusProcessor : public MIDASWipeProcessor<TPixel, VImageDimension> {

public:

  /** Standard class typedefs */
  typedef MIDASWipePlusProcessor                      Self;
  ...
  itkTypeMacro(MIDASWipePlusProcessor, MIDASWipeProcessor);
...
protected:
  MIDASWipePlusProcessor();
  virtual ~MIDASWipePlusProcessor() {}

private:
  MIDASWipePlusProcessor(const Self&); //purposely not implemented
...
#include "itkMIDASWipePlusProcessor.txx"
#endif

#endif // ITKMIDASWIPEPLUSPROCESSOR_H
