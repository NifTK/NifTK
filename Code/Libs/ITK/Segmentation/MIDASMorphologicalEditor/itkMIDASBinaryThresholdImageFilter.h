...
namespace itk
{
  ...
  /**
   * \class MIDASBinaryThresholdImageFilter
   * \brief Class that can threshold an image, and apply a region of interest mask.
   * \deprecated Currently not actually used in MIDAS, as we use the default itk::BinaryThresholdImageFilter
   * followed by itk::MIDASMaskByRegionImageFilter.
   */
