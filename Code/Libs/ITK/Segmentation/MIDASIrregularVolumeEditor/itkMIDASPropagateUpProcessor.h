...
#ifndef ITKMIDASPROPAGATEUPPROCESSOR_H
#define ITKMIDASPROPAGATEUPPROCESSOR_H
...
/**
 * \class MIDASPropagateUpProcessor
 * \brief Provides the MIDAS Propagate Up operation in the Irregular Volume Editor.
...
class ITK_EXPORT MIDASPropagateUpProcessor : public MIDASPropagateProcessor<TSegmentationPixel, TGreyScalePixel, TPointDataType, VImageDimension> {

public:

  /** Standard class typedefs */
  typedef MIDASPropagateUpProcessor                                                                     Self;
  ...
  itkTypeMacro(MIDASPropagateUpProcessor, MIDASPropagateProcessor);
...
protected:
  ...
  virtual ~MIDASPropagateUpProcessor() {}

private:
  MIDASPropagateUpProcessor(const Self&); //purposely not implemented
...
#include "itkMIDASPropagateUpProcessor.txx"
#endif

#endif // ITKMIDASPROPAGATEUPPROCESSOR_H
