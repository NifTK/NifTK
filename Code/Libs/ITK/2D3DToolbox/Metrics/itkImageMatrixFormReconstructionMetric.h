...
class ITK_EXPORT ImageMatrixFormReconstructionMetric : public SingleValuedCostFunction
{
public:

  /** Standard class typedefs. */
  typedef ImageMatrixFormReconstructionMetric    	Self;
  ...
  itkTypeMacro(ImageMatrixFormReconstructionMetric, SingleValuedCostFunction);
  ...
  void SetInputProjectionVector( VectorType &inProjection ) { m_inProj = inProjection; }
...
private:
  ImageMatrixFormReconstructionMetric(const Self&); //purposely not implemented
...
#include "itkImageMatrixFormReconstructionMetric.txx"
#endif
