...
#ifndef __itkInvNormalizedCorrelationImageToImageMetric_txx
...
InvNormalizedCorrelationImageToImageMetric<TFixedImage,TMovingImage>
 ...
 */
template <class TFixedImage, class TMovingImage> 
typename InvNormalizedCorrelationImageToImageMetric<TFixedImage,TMovingImage>::MeasureType
InvNormalizedCorrelationImageToImageMetric<TFixedImage,TMovingImage>
::GetValue( const TransformParametersType & parameters ) const
{
  //std::cout << "You are inside the GetValue function of the metric" << std::endl;  
  ...
  while(!ti.IsAtEnd())
    ...
    OutputPointType transformedPoint = inputPoint;// this->m_Transform->TransformPoint( inputPoint );
