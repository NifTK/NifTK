...
#ifndef __itkMatrixBasedSimulReconRegnMetric_h
#define __itkMatrixBasedSimulReconRegnMetric_h
...
class ITK_EXPORT MatrixBasedSimulReconRegnMetric : public SingleValuedCostFunction
{
public:

  /** Standard class typedefs. */
  typedef MatrixBasedSimulReconRegnMetric    	Self;
  ...
  itkTypeMacro(MatrixBasedSimulReconRegnMetric, SingleValuedCostFunction);
  ...
  typedef AffineTransformerType::EulerAffineTransformType 							EulerAffineTransformType;
	typedef typename AffineTransformerType::Pointer 											AffineTransformerPointer;
  ...
  void SetEulerTransform( EulerAffineTransformPointer inEuler ) { m_EulerAffineTransform = inEuler; }
  ...
  /// Set the Finite Difference Method (FDM) lambda value, difference value, and epsilon value
	void SetEulerTransformFDMLambda( double &lambdaVal ) { m_lambdaVal = lambdaVal; }
  void SetEulerTransformFDMDifference( double &diffFDMVal ) { m_FDMDiff = diffFDMVal; }
  void SetEulerTransformFDMDifferenceEpsilon( double &epsilonVal ) { m_epsilonVal = epsilonVal; }
...
private:
  MatrixBasedSimulReconRegnMetric(const Self&); //purposely not implemented
...
#include "itkMatrixBasedSimulReconRegnMetric.txx"
#endif
