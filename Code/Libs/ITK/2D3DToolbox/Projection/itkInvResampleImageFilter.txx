...
#ifndef __itkInvResampleImageFilter_txx
#define __itkInvResampleImageFilter_txx
...
InvResampleImageFilter<TInputImage, TOutputImage,TInterpolatorPrecisionType>
::InvResampleImageFilter()
{
...
::BeforeThreadedGenerateData()
{
  if( !m_Transform )
    {
      niftkitkWarningMacro("Transform not set");
    }

  if( !m_Interpolator )
    {
      niftkitkWarningMacro("Interpolator not set");
    }
  ...
  int threadId)
{
  ...
  while ( !outIt.IsAtEnd() )
    ...
    inputPoint = outputPoint;//m_Transform->TransformPoint(outputPoint);/////////////////////////
  ...
  int threadId)
{
  ...
  tmpInputPoint =  tmpOutputPoint;// m_Transform->TransformPoint( tmpOutputPoint );//////////////////
  ...
  while ( !outIt.IsAtEnd() )
    ...
    /*if ( (index[0]==0)&(index[1]==0)&(index[2]==0) )
      {
    	std::cout << "The index is: " << inputIndex << std::endl;
    	std::cout << "to physical coords is: " << outputPoint << std::endl;
	}*/
    //if ( index[0]>0 )
    //std::cout << "Index: " << index << std::endl;
    //if ( outputPoint[0]>0 )
    //  {
    //std::cout << "the physical coords of the point: " << outputPoint << std::endl;
	//  }
    ...
    /*if ( (index[0]==0)&(index[1]==0)&(index[2]==0) )
      {
    	std::cout << "The inputPoint is: " << inputPoint << std::endl;
    	std::cout << "The inputIndex is: " << inputIndex << std::endl;
	}*/
    ...
    /*if ( (index[0]==90)&(index[1]==90)&(index[2]==250) )
      {
    	std::cout << "The inputIndex rounded is: " << inputIndex << std::endl;
      }*/

    while( !outIt.IsAtEndOfLine() )
      {
	/*if ( (outIt.GetIndex()[0]==247)&(outIt.GetIndex()[1]==243)&(outIt.GetIndex()[2]==0) )
	{
	  std::cout << "The imageIndex is: " << outIt.GetIndex() << std::endl;
	  std::cout << "The inputIndex is: " << inputIndex << std::endl;
	  //transform to physical coords
          outputPtr->TransformIndexToPhysicalPoint( outIt.GetIndex(), outputPoint );
    	  std::cout << "to physical coords is: " << outputPoint << std::endl;	
          inputPoint = m_Transform->TransformPoint(outputPoint);
    	  std::cout << "the transformed point is: " << inputPoint << std::endl;
          inputPtr->TransformPhysicalPointToContinuousIndex(inputPoint, inputIndex);
	  std::cout << "The inputIndex is: " << inputIndex << std::endl;
	  }*/
      // Evaluate input at right position and copy to the output
	...
	PixelType pixval;
        const OutputType value
          = m_Interpolator->EvaluateAtContinuousIndex(inputIndex);
        //if ( (outIt.GetIndex()[0]==250)&(outIt.GetIndex()[1]==237)&(outIt.GetIndex()[2]==0) )
 ...
 */
template <class TInputImage, class TOutputImage, class TInterpolatorPrecisionType>
const typename InvResampleImageFilter<TInputImage,TOutputImage,TInterpolatorPrecisionType>::OutputImageType *
InvResampleImageFilter<TInputImage,TOutputImage,TInterpolatorPrecisionType>
...
{
  niftkitkDebugMacro("setting input ReferenceImage to " << image);
