...
class ITK_EXPORT InvRayCastInterpolateImageFunction : 
    public InterpolateImageFunction<TInputImage,TCoordRep> 
{
public:
  /** Standard class typedefs. */
  typedef InvRayCastInterpolateImageFunction              Self;
  ...
  itkTypeMacro(InvRayCastInterpolateImageFunction, InterpolateImageFunction);
...
private:
  InvRayCastInterpolateImageFunction( const Self& ); //purposely not implemented
...
#include "itkInvRayCastInterpolateImageFunction.txx"
#endif
