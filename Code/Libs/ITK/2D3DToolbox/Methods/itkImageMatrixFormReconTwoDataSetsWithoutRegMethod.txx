...
ImageMatrixFormReconTwoDataSetsWithoutRegMethod<IntensityType>
...
template< class IntensityType>
typename ImageMatrixFormReconTwoDataSetsWithoutRegMethod<IntensityType>::InputProjectionVolumeType *
ImageMatrixFormReconTwoDataSetsWithoutRegMethod<IntensityType>
::GetInput()
{
...
template< class IntensityType>
typename ImageMatrixFormReconTwoDataSetsWithoutRegMethod<IntensityType>::MatrixFormReconstructionOutputType *
ImageMatrixFormReconTwoDataSetsWithoutRegMethod<IntensityType>
::GetOutput()
{
...
::Initialise( void ) throw (ExceptionObject)
{
  ...
  niftkitkDebugMacro("ImageMatrixFormReconTwoDataSetsWithoutRegMethod<IntensityType>::Initialise()" );
  ...
  if ( !m_ProjectionGeometry )
	itkWarningMacro( "Projection geometry is not present" );
