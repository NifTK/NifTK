 ...
 * 
 * RegionGrowSurfacePoints labels pixels with ReplaceValue that are
...
class ITK_EXPORT RegionGrowSurfacePoints:
...
public:
  ...
  itkTypeMacro(RegionGrowSurfacePoints,
               ImageToImageFilter);
...
private:
  RegionGrowSurfacePoints(const Self&); //purposely not implemented
...
#include "itkRegionGrowSurfacePoints.txx"
#endif
