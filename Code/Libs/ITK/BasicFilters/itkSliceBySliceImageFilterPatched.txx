/*=========================================================================
  ...
  Language:  C++
  Date:      $Date: 2012-10-31 15:16:00 +0000 (Wed, 31 Oct 2012) $
  Version:   $Revision: 9613 $
...
::GenerateData()
{
  ...
  unsigned int i, j;
  for( i=0, j=0; i < InternalImageDimension; i++, j++ )
    {
    if( i == this->m_Dimension )
      j++;

    internalSize[i] = requestedSize[j];
    internalIndex[i] = requestedIndex[j];
    }
