...
/**
 * Test the BinaryUnionWithPaddingImageFilter by generating 5x5x5 images
 * and filling them with random values between 0 to 4, then testing whether 
 * the output image is generated correctly. 
 */

int itkBinaryUnionWithPaddingImageFilterTest(int, char* []) 
{
  srand(time(NULL));
  ...
  typedef itk::BinaryUnionWithPaddingImageFilter< ImageType1,
