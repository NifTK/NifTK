...
#ifndef __mitkGeneralSegmentorPipeline_h
#define __mitkGeneralSegmentorPipeline_h
...
public:
  ...
  static void ConvertMITKSeedsAndAppendToITKSeeds(mitk::PointSet *seeds, itk::PointSet<float, 3> *points);
  ...
  ///
  static void ConvertMITKContoursAndAppendToITKContours(mitk::ContourModelSet* mitkContours, ParametricPathVectorType& itkContours, const mitk::Vector3D& spacing);
...
#include "mitkGeneralSegmentorPipeline.txx"
#endif
