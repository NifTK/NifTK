...
public:
  ...
  void Setup(char* argv[])
  {
    ...
    m_RenderWindow = mitk::RenderWindow::New(NULL, "niftkMIDASPaintbrushToolClass", m_RenderingManager);
 ...
 */
int niftkMIDASPaintbrushToolTest(int argc, char * argv[])
{
  // always start with this!
  MITK_TEST_BEGIN("niftkMIDASPaintbrushToolTest");
