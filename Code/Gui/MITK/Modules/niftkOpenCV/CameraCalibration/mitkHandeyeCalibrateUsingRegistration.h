...
#ifndef mitkHandeyeCalibrateUsingRegistration_h
#define mitkHandeyeCalibrateUsingRegistration_h
...
public:
   ...
   * where all points in modelInputFile will be multiplied by these matrices to give coordinates in tracker (world) space.
...
protected:
  ...
  HandeyeCalibrateUsingRegistration(const HandeyeCalibrateUsingRegistration&); // Purposefully not implemented.
  HandeyeCalibrateUsingRegistration& operator=(const HandeyeCalibrateUsingRegistration&); // Purposefully not implemented.
