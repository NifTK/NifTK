...
#ifndef ITKDRCANALYZEIMAGEIO3160_CXX
#define ITKDRCANALYZEIMAGEIO3160_CXX
...
DRCAnalyzeImageIO3160::DRCAnalyzeImageIO3160()
{
  // Default to DRC mode.
  m_DRCMode = true;
}
...
void DRCAnalyzeImageIO3160::PrintSelf(std::ostream& os, Indent indent) const {
...
void DRCAnalyzeImageIO3160::ReadImageInformation() {
  ...
  if (m_DRCMode) {
    ...
    itkDebugMacro(<< "DRCAnalyzeImageIO3160::ReadImageInformation(): - Providing DRC specific functionality.");
...
#undef itkAnalzyeImageIO_MINDIMS_IS_THREE
  ...
  {
    itkDebugMacro(<< "DRCAnalyzeImageIO3160::ReadImageInformation(): - Providing base class (ITK) functionality from itkAnalyzeImageIO.");
  }
}

ImageIOBase::ByteOrder
DRCAnalyzeImageIO3160::CheckAnalyzeEndian(const struct dsr &temphdr)
{
...
void
DRCAnalyzeImageIO3160::SwapHeaderBytesIfNecessary( ImageIOBase::ByteOrder& byteOrder, struct dsr * const imageheader )
{
