/*=========================================================================
  ...
  Language:  C++
  Date:      $Date: 2011-09-08 16:23:32 +0100 (Thu, 08 Sep 2011) $
...
/**************************************************************************
 * NifTK Note: This is take from ITK 3.16.0 (hence the name).
 * It is a cut and paste with a name change, as the spec changed between
 * ITK version 3.16.0 and 3.20.0. The version in 3.20.0 additionally checks
 * fields like the vox_offset, which at the DRC are incorrectly set. This
 * version taken from ITK version 3.16.0, and the derived subclass called
...
public:
  ...
  itkTypeMacro(AnalyzeImageIO3160, Superclass);
...
AnalyzeImageIO3160(const Self&); //purposely not implemented
...
/** Making these private static const, instead of extern const. */
