    ...
    QString applicationPlugin)
{
  ...
  sbConfig->setString(berry::Platform::ARG_PRELOAD_LIBRARY, "libuk_ac_ucl_cmic_midasmorphologicalsegmentor,libuk_ac_ucl_cmic_midasgeneralsegmentor,libuk_ac_ucl_cmic_gui_qt_commonmidas,libuk_ac_ucl_cmic_niftyreg");
#endif
