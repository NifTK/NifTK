...
#ifndef niftkMIDASSegmentationPerspective_h
#define niftkMIDASSegmentationPerspective_h
 ...
 */
class CMIC_QT_COMMONAPPS niftkMIDASSegmentationPerspective : public QObject, public berry::IPerspectiveFactory
{
  Q_OBJECT
...
public:
  ...
  niftkMIDASSegmentationPerspective();
  niftkMIDASSegmentationPerspective(const niftkMIDASSegmentationPerspective& other);
