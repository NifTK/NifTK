...
// --------------------------------------------------------------------------
mitk::DataStorage* uk_ac_ucl_cmic_dnddisplay_Activator::GetDataStorage()
{
  assert(s_PluginContext);

  mitk::DataStorage::Pointer dataStorage = 0;

  ctkServiceReference dsServiceRef = s_PluginContext->getServiceReference<mitk::IDataStorageService>();
  if (dsServiceRef)
  {
    mitk::IDataStorageService* dsService = s_PluginContext->getService<mitk::IDataStorageService>(dsServiceRef);
    if (dsService)
    {
...
//-----------------------------------------------------------------------------
void uk_ac_ucl_cmic_dnddisplay_Activator::ProcessCommandLineArguments()
{
...
// --------------------------------------------------------------------------
void uk_ac_ucl_cmic_dnddisplay_Activator::DropNodes(QmitkRenderWindow* renderWindow, const std::vector<mitk::DataNode*>& nodes)
{
