...
#ifndef MITKQTNIFTYIGIAPPDLL_H_
#define MITKQTNIFTYIGIAPPDLL_H_
...
//
  ...
  #if defined(uk_ac_ucl_cmic_gui_qt_niftyigi_EXPORTS)
    #define CMIC_QT_NIFTYIGIAPP __declspec(dllexport)
  #else
    #define CMIC_QT_NIFTYIGIAPP __declspec(dllimport)
  #endif
#endif

#if !defined(CMIC_QT_NIFTYIGIAPP)
  #define CMIC_QT_NIFTYIGIAPP
#endif

#endif /*MITKQTNIFTYIGIAPPDLL_H_*/
