...
#ifndef QMITKFUNCTIONALITYWITHOUTSTDMULTIWIDGET_H_
#define QMITKFUNCTIONALITYWITHOUTSTDMULTIWIDGET_H_
...
///
/// \class QmitkFunctionalityWithoutStdMultiWidget
///
/// \brief The base class of all MITK related blueberry views (~ in the old version of MITK, this was called "Functionality")
///
/// QmitkFunctionalityWithoutStdMultiWidget provides several convenience methods that eases the introduction of a new view:
///
/// <ol>
...
public:
  ...
  ///
  berryObjectMacro(QmitkFunctionalityWithoutStdMultiWidget)
  ///
  ...
  ///
  QmitkFunctionalityWithoutStdMultiWidget();
  ///
  /// Disconnects all standard event listeners
  ///
  virtual ~QmitkFunctionalityWithoutStdMultiWidget();
  ///
...
public:
  ...
  /// by QmitkFunctionalityWithoutStdMultiWidget. By having this proxy method the user does not have to
  /// call QmitkFunctionalityWithoutStdMultiWidget::ClosePart() when overwriting ClosePart()
  ///
  void ClosePartProxy();
...
protected:
  ...
  /// Here standard event listeners for a QmitkFunctionalityWithoutStdMultiWidget are registered
  ///
...
protected:
  ...
  ///
  friend struct berry::SelectionChangedAdapter<QmitkFunctionalityWithoutStdMultiWidget>;
  ///
...
#endif /*QMITKFUNCTIONALITYWITHOUTSTDMULTIWIDGET_H_*/
