...
public:
  ...
  ///
  berryNewMacro1Param(QmitkFunctionalitySelectionProvider, QmitkFunctionalityWithoutStdMultiWidget*)
...
protected:
  ...
  /// nothing to do here
  ///
  QmitkFunctionalitySelectionProvider(QmitkFunctionalityWithoutStdMultiWidget* _Functionality);
  ///
  /// nothing to do here
  ///
  ...
  ///
  QmitkFunctionalityWithoutStdMultiWidget* m_Functionality;
  ///
