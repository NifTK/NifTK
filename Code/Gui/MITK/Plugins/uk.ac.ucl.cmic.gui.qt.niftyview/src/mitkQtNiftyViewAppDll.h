...
#ifndef MITKQTNIFTYVIEWAPPDLL_H_
#define MITKQTNIFTYVIEWAPPDLL_H_
...
//
  ...
  #if defined(uk_ac_ucl_cmic_gui_qt_niftyview_EXPORTS)
    #define CMIC_QT_NIFTYVIEWAPP __declspec(dllexport)
  #else
    #define CMIC_QT_NIFTYVIEWAPP __declspec(dllimport)
  #endif
#endif

#if !defined(CMIC_QT_NIFTYVIEWAPP)
  #define CMIC_QT_NIFTYVIEWAPP
#endif

#endif /*MITKQTNIFTYVIEWAPPDLL_H_*/
