...
"         <state NAME=\"stateStart\"  START_STATE=\"TRUE\"   ID=\"1\" X_POS=\"50\"   Y_POS=\"100\" WIDTH=\"100\" HEIGHT=\"50\">"
"           <transition NAME=\"shiftRightButtonDown\" NEXT_STATE_ID=\"1\" EVENT_ID=\"2000\">"
"             <!-- 10 = AcADDPOINT  -->"
"             <action ID=\"10\" />"
"             <!-- 72 = AcDESELECTALL  -->"
"             <action ID=\"72\" />"
...
"         <state NAME=\"stateStart\"  START_STATE=\"TRUE\"   ID=\"1\" X_POS=\"50\"   Y_POS=\"100\" WIDTH=\"100\" HEIGHT=\"50\">"
"           <transition NAME=\"shiftMiddleButtonDown\" NEXT_STATE_ID=\"2\" EVENT_ID=\"2003\">"
"             <!-- 30 = AcCHECKELEMENT  -->"
"             <action ID=\"30\" />"
"           </transition>"
"           <transition NAME=\"shiftMiddleButtonDownMouseMove\" NEXT_STATE_ID=\"2\" EVENT_ID=\"2005\">"
"             <!-- 30 = AcCHECKELEMENT  -->"
"             <action ID=\"30\" />"
"           </transition>"
...
"           </transition>"
"         </state>"
"         <state NAME=\"guardShiftMiddleButtonPointSelected\"   ID=\"2\" X_POS=\"100\" Y_POS=\"150\" WIDTH=\"100\" HEIGHT=\"50\">"
...
"             <action ID=\"90\" />"
"           </transition>"
"           <transition NAME=\"shiftMiddleButtonUp\" NEXT_STATE_ID=\"1\" EVENT_ID=\"2004\">"
"             <!-- 76 = AcDESELECTPOINT  -->"
"             <action ID=\"76\" />"
"           </transition>"
"         </state>"
...
"             <action ID=\"320403\" />"
"           </transition>"
"           <transition NAME=\"shiftMiddleButtonDown\" NEXT_STATE_ID=\"1\" EVENT_ID=\"2003\">"
"             <action ID=\"320404\" />"
"           </transition>"
"           <transition NAME=\"shiftMiddleButtonUp\" NEXT_STATE_ID=\"1\" EVENT_ID=\"2004\">"
"             <action ID=\"320405\" />"
"           </transition>"
"           <transition NAME=\"shiftMiddleButtonDownMouseMove\" NEXT_STATE_ID=\"1\" EVENT_ID=\"2005\">"
"             <action ID=\"320406\" />"
"           </transition>"
"           <transition NAME=\"shiftRightButtonDown\" NEXT_STATE_ID=\"1\" EVENT_ID=\"2000\">"
"             <action ID=\"320407\" />"
"           </transition>"
"           <transition NAME=\"shiftRightButtonUp\" NEXT_STATE_ID=\"1\" EVENT_ID=\"2001\">"
"             <action ID=\"320408\" />"
"           </transition>"
"           <transition NAME=\"shiftRightButtonDownMouseMove\" NEXT_STATE_ID=\"1\" EVENT_ID=\"2002\">"
"             <action ID=\"320409\" />"
"           </transition>"
"         </state>"
"      </stateMachine>"
