...
*/
class MITKSegmentationView : public niftkMIDASBaseSegmentationFunctionality
{  
...
private:
  ...
  /// \brief Container for the Morphological Controls Widgets. \see niftkMIDASBaseSegmentationFunctionality
