...
bool QmitkSegmentationPreferencePage::PerformOk()
{
  ...
  m_SegmentationPreferencesNode->Put(niftkBaseSegmentorView::DEFAULT_COLOUR_STYLE_SHEET, m_DefauleColorStyleSheet.toStdString());
  m_SegmentationPreferencesNode->PutByteArray(niftkBaseSegmentorView::DEFAULT_COLOUR, m_DefaultColor);
...
void QmitkSegmentationPreferencePage::Update()
{
  ...
  m_DefauleColorStyleSheet = QString::fromStdString(m_SegmentationPreferencesNode->Get(niftkBaseSegmentorView::DEFAULT_COLOUR_STYLE_SHEET, ""));
  m_DefaultColor = m_SegmentationPreferencesNode->GetByteArray(niftkBaseSegmentorView::DEFAULT_COLOUR, "");
