...
//-----------------------------------------------------------------------------
QmitkQCPerspective::QmitkQCPerspective()
{
}
 

//-----------------------------------------------------------------------------
QmitkQCPerspective::QmitkQCPerspective(const QmitkQCPerspective& other)
{
  Q_UNUSED(other)
...
//-----------------------------------------------------------------------------
void QmitkQCPerspective::CreateInitialLayout(berry::IPageLayout::Pointer layout)
{
