...
{
  m_MIDASGeneralSegmentorViewPreferencesNode->Put(niftkMIDASBaseSegmentationFunctionality::DEFAULT_COLOUR_STYLE_SHEET, m_DefauleColorStyleSheet);
  m_MIDASGeneralSegmentorViewPreferencesNode->Put(niftkMIDASBaseSegmentationFunctionality::DEFAULT_COLOUR, m_DefaultColor);
...
{
  m_DefauleColorStyleSheet = m_MIDASGeneralSegmentorViewPreferencesNode->Get(niftkMIDASBaseSegmentationFunctionality::DEFAULT_COLOUR_STYLE_SHEET, "");
  m_DefaultColor = m_MIDASGeneralSegmentorViewPreferencesNode->Get(niftkMIDASBaseSegmentationFunctionality::DEFAULT_COLOUR, "");
