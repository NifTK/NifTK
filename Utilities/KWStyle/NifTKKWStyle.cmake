...
OPTION(NIFTK_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
IF(NIFTK_USE_KWSTYLE)
...
SET(KWSTYLE_CONFIGURATION_FILE 
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/NifTKKWS.xml)

SET(KWSTYLE_NIFTK_FILES_LIST
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/NifTKFiles.txt)

SET(KWSTYLE_NIFTK_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/NifTKOverwrite.txt )

#
# Configure the files
#
CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/NifTKFiles.txt.in
  ${KWSTYLE_NIFTK_FILES_LIST})

CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/NifTKKWS.xml.in
...
SET(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_NIFTK_FILES_LIST}
  -o ${KWSTYLE_NIFTK_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

ADD_CUSTOM_COMMAND(
  OUTPUT  ${NIFTK_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

ADD_CUSTOM_TARGET(StyleCheckCode DEPENDS ${NIFTK_BINARY_DIR}/KWStyleCodeReport.txt)

ADD_TEST(KWStyleCodeTest   ${KWSTYLE_EXECUTABLE} ${KWSTYLE_ARGUMENTS_CODE})

ENDIF(KWSTYLE_FOUND)
ENDIF(KWSTYLE_EXECUTABLE)
ENDIF(NIFTK_USE_KWSTYLE)
