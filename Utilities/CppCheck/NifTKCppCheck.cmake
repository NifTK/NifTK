...
OPTION(NIFTK_USE_CPPCHECK "Enable the use of CppCheck for static analysis." OFF)
IF(NIFTK_USE_CPPCHECK)
  ...
  IF(CPPCHECK_EXECUTABLE)
    ...
    IF(CPPCHECK_FOUND)
      ...
      #  Define file names
      #
      SET(CPPCHECK_NIFTK_FILES_LIST
        ${PROJECT_BINARY_DIR}/Utilities/CppCheck/NifTKFiles.txt)

      #
      # Configure the files
      #
      CONFIGURE_FILE(
        ${PROJECT_SOURCE_DIR}/Utilities/CppCheck/NifTKFiles.txt.in
        ${CPPCHECK_NIFTK_FILES_LIST})
      ...
      ADD_CUSTOM_COMMAND(
        OUTPUT  ${NIFTK_BINARY_DIR}/CppCheckCodeReport.txt
        COMMAND ${CPPCHECK_EXECUTABLE}
        ARGS    ${CPPCHECK_ARGUMENTS_CODE}
        COMMENT "Coding Style Checker"
      )

      ADD_CUSTOM_TARGET(StaticallyAnalyzeCode DEPENDS ${NIFTK_BINARY_DIR}/CppCheckCodeReport.txt)

      ADD_TEST(CppCheckCodeTest ${CPPCHECK_EXECUTABLE} ${CPPCHECK_ARGUMENTS_CODE})

    ENDIF(CPPCHECK_FOUND)
  ENDIF(CPPCHECK_EXECUTABLE)
ENDIF(NIFTK_USE_CPPCHECK)
