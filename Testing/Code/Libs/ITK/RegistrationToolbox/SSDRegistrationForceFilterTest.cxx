...
int SSDRegistrationForceFilterTest(int argc, char * argv[])
{
  if( argc < 9)
    {
    std::cerr << "Usage   : SSDRegistrationFilterTest img1 img2 expectedTotalNMI tolerance testPointX testPointY forceX forceY" << std::endl;
    return 1;
    }
  ...
  typedef itk::SSDRegistrationForceFilter<ImageType, ImageType, double> ForceFilterType;
